...
function Footer() {
  return (
    <footer className="border-t border-line bg-ink px-5 py-10 md:px-11">
      <Reveal className="flex flex-wrap gap-10 border-b border-line pb-9">
        <div className="max-w-[34ch]">
          ...
          <p className="mt-4 text-sm font-light text-paper-dim">
            Página de vitrine da Yamaha MT-07, refeita como estudo de interface
            e de fluxo de compra.
          </p>
        </div>
